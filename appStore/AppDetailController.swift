...
//  appStore
//
//  Created by Mladen Vidović on 26/10/2016.
...
class AppDetailController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    private func descriptionAtributedText() -> NSAttributedString {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if indexPath.item == 1 {
            ...
            let rect = descriptionAtributedText().boundingRect(with: dummySize, options: options, context: nil)
...
class AppDetailHeader: BaseCell {
    ...
    let buyButton: UIButton = {
        ...
        button.layer.borderColor = UIColor(red: 0, green: 129/255, blue: 255/255, alpha: 1).cgColor
